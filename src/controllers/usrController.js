...
let getUsrData = async function(req,res){
    let getId = req.body.emailId
    let getPwd = req.body.password
let getEmail = await userModel.findOne({emailId:getId})
let getPsswrd = await userModel.findOne({password:getPwd})

if(!getEmail || !getPsswrd){
...
module.exports.getUsrData = getUsrData*/
